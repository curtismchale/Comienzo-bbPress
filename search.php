<?php bb_get_header(); ?>
    ...
    <div id="results-recent" class="search-results">
        ...
        <?php endforeach; // $recent as $bb_post ?>
    	</ol>
    	
    </div><!-- /#results-recent .search-results -->
    <?php endif; //$recent ?>
    ...
    <div id="results-relevant" class="search-results">
        ...
        <?php endforeach; //$relevant as $bb_post ?>
    	</ol>
   
    </div><!-- /#results-relevant .search-results -->
    <?php endif; //$relevant ?>
    ...
    <p id="search-in-google"><?php printf(__('You may also try your <a href="http://google.com/search?q=site:%1$s %2$s">search at Google</a>'), bb_get_uri(null, null, BB_URI_CONTEXT_TEXT), urlencode($q)) ?></p>
