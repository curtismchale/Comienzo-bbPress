<!-- this is the form that supplies the post edit form -->
<?php if ( $topic_title ) : ?>
...
<?php endif; do_action( 'edit_form_pre_post' ); ?>
    ...
    <p>
        <label><?php _e('Post:'); ?><br />
            <textarea name="post_content" cols="50" rows="8" id="post_content">
                <?php echo apply_filters('edit_text', get_post_text() ); ?>
            </textarea>
        </label>
    </p>
