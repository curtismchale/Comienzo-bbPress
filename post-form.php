...
<?php endif; //bb_is_tag bb_is_front ?>
...
</p><!-- /#post-form-submit-contianer .submit -->

<p id="post-form-allowed-container" class="allowed">
    <?php _e('Allowed markup:'); ?>
    <code><?php allowed_markup(); ?></code>.
    <br /><?php _e('You can also put code in between backtick ( <code>`</code> ) characters.'); ?>
</p><!-- /#post-form-allowed-container .allowed -->