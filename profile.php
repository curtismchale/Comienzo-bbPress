<?php bb_get_header(); ?>
    ...
    <div class="vcard" role="main">
        ...
        <?php elseif ( $user_id == bb_get_current_user_info( 'id' ) ) : //$updated ?>
        ...
        <p>
            ...
            <?php endif; //bb_current_user_can('edit_user') ?>
        </p>
        ...
        <?php endif; // bb_current_user_can('edit_favorites_of') ?>
        <?php endif; //$updated ?>
    ...
    <div id="user-replies" class="user-recent">
        ...
        <ol>
            ...
            <?php endforeach; //$posts as $bb_post ?>
        </ol>
    ...
    <div id="user-threads" class="user-recent">
        ...
        <?php endforeach; //$topics as $topic ?>
        </ol>
